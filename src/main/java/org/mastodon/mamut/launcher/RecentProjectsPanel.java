...
public class RecentProjectsPanel extends JPanel
{
	...
	private void remakeGUI( final Consumer< String > projectOpener )
	{
		...
		gbc.gridy++;
		gbc.gridx = 0;
		final JLabel lblTitle2Hint = new JLabel( "Or Drag&Drop .mastodon file onto Fiji window" );
		lblTitle2Hint.setHorizontalAlignment( SwingConstants.CENTER );
		lblTitle2Hint.setVerticalAlignment( SwingConstants.NORTH );
		lblTitle2Hint.setFont( lblTitle2.getFont() );
		add( lblTitle2Hint, gbc );
	...
	public static final class MouseDblClickOpenPath implements MouseListener {
		...
		public void mouseClicked(MouseEvent mouseEvent) {
			if (mouseEvent.getClickCount() == 2) {
				System.out.println( "Going to open " + Uri );
				openUrl( Uri );
			}
		}
